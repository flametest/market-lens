...
func NewRouter(corsOrigins []string, mgr *data.Manager, repo *data.Repository, strategyEngine *strategy.Engine, backtestEngine *backtest.Engine, execEngine *execution.Engine, analyzer *ai.Analyzer) http.Handler {
